...
<?php wp_body_open(); ?>
  ...
  <!-- KAIKO NAVIGATION -->
  <nav class="kaiko-nav" id="kaiko-nav">
  ...
  <!-- MOBILE SLIDE-OUT MENU -->
  <div class="kaiko-mobile-menu" id="kaiko-mobile-menu">
    ...
    <div class="kaiko-mobile-menu__footer">
      <a href="/my-account/" class="btn-primary"><?php echo is_user_logged_in() ? 'My Account' : 'Trade Login'; ?></a>
    </div>
  </div>
...
(function() {
  ...
  /* Desktop nav inline styles to override WoodMart */
  ...
  if (navLinks && !isMobile) {
    ...
    links.forEach(function(a) {
      a.style.cssText = "font-family:'Inter',-apple-system,sans-serif!important;font-size:0.9rem!important;font-weight:500!important;color:#6b6963!important;text-decoration:none!important;letter-spacing:0.025em!important;transition:color 0.2s!important;";
    });
